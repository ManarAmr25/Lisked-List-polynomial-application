...
public class DoublyLinkedList implements ILinkedList {
	...
	public void add(int index, Object element) { //index starts from 0  //insert anywhere except the end
		...
		if(index < size && index >= 0 && element != null) {			//should I throw an exception if the index is out of range ?********
	...
	@Override
	public void set(int index, Object element) {		//Replaces the element at the specified position with the specified element.
		// TODO Auto-generated method stub
		if(index < size && index >= 0) {
			NodeDoubly node = head;
			for(int i = 0 ; i <= index ; i++) {
	...
	@Override
	public boolean contains(Object o) {		//true if this list contains an element with the same value as the specified element
		// TODO Auto-generated method stub
		NodeDoubly node = head;
